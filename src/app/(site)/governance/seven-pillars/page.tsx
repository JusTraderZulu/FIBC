...
export const metadata = { title: "Seven Pillars of Governance" };
    ...
    <div>
      ...
      <Section className="bg-[hsl(var(--brand))]/5 pt-12 pb-12">
        <div className="text-center max-w-3xl mx-auto">
          <h2 className="text-2xl font-serif tracking-tight mb-3">Apostolic Foundation</h2>
          <p className="text-black/70 mb-6 leading-relaxed">
            The Seven Pillars form the Apostolic-Patriarchal backbone of Faith International Baptist Convention Inc., 
            ensuring biblical governance and corporate discipline across our worldwide fellowship.
          </p>
